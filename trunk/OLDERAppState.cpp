...
bool AppState::SaveState()
{
	...
	if (outputfile.good())
	{
		outputfile << "numtrials " << Trials.size() << "\n";
		...
		for (counter1=0;counter1<(int)Trials.size();counter1++)
		{
			if (Trials[counter1])
			{
				...
				outputfile << "compliance " << Trials[counter1]->Compliance << "\n";
				outputfile << "friction " << Trials[counter1]->Friction << "\n";
				...
				outputfile << "complianceresult " << Trials[counter1]->ComplianceResult << "\n";
				outputfile << "frictionresult " << Trials[counter1]->FrictionResult << "\n";
	...
	if (inputfile.is_open())
	{
		...
		{		
			...
			if (sstr >> param1)
			{
				...
				else if (param1.compare("compliance")==0)
				{
					if ((trialnum < numtrials) && (trialnum < (int)Trials.size()))
					{
						int val = 0;
						...
						if (sstr >> val)
						{
							Trials[trialnum]->Compliance = val;
						}
					}
				}
				else if (param1.compare("friction")==0)
				{
					if ((trialnum < numtrials) && (trialnum < (int)Trials.size()))
					{
						int val = 0;
				...
				else if (param1.compare("complianceresult")==0)
				{
					if ((trialnum < numtrials) && (trialnum < (int)Trials.size()))
					{
						double result = 0;
						...
						if (sstr >> result)
						{
							Trials[trialnum]->ComplianceResult = result;
						}
					}
				}
				else if (param1.compare("frictionresult")==0)
				{
					if ((trialnum < numtrials) && (trialnum < (int)Trials.size()))
					{
						double result = 0;
						...
						if (sstr >> result)
						{
							Trials[trialnum]->FrictionResult = result;
						}
					}
				}
			}
...
bool AppState::SaveExcel()
{
	...
	if (outputfile.good())
	{
		...
		outputfile << "----------------------\n\n";
		outputfile << "Trial Number | Haptic Presence | Environment | Glossiness | Compliance | Friction | Timer 1 | Timer 2 | Timer 3 | GlossResult | ComplianceResult | FrictionResult\n";
		outputfile << "----------------------\n";
		...
		for (counter1=0;counter1<(int)Trials.size();counter1++)
		{
			if (Trials[counter1])
			{
				if (Trials[counter1]->InstructionTrial == false)
				{
					...
					outputfile << Trials[counter1]->Compliance << sepchars;
					outputfile << Trials[counter1]->Friction << sepchars;
					...
					outputfile << Trials[counter1]->ComplianceResult << sepchars;
					outputfile << Trials[counter1]->FrictionResult << "\n";
				}
			}
		}
